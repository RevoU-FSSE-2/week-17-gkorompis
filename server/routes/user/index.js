...
import { userPostMiddlewares, userGetMiddlewares, userGetOneMiddlewares, userPutMiddlewares, userDeleteMiddlewares, userDeleteManyMiddlewares } from "./middlewares.js";
const app = express();
app.use(express.json());
const userRoute = express.Router();
const { userGetController, userGetOneController, userPostController, userPutController, userDeleteController, userDeleteManyController } = userController;
/**
 * @openapi
 * paths:
 *   /user:
 ...
 */
// routes
userRoute.get("/", userGetMiddlewares, userGetController);
userRoute.get("/one/:id", userGetOneMiddlewares, userGetOneController);
userRoute.post("/", userPostMiddlewares, userPostController);
userRoute.put("/one/:id", userPutMiddlewares, userPutController);
userRoute.delete("/one/:id", userDeleteMiddlewares, userDeleteController);
userRoute.delete("/many", userDeleteManyMiddlewares, userDeleteManyController);
