...
import { 
    serviceRequestPostMiddlewares,
    serviceRequestGetMiddlewares,
    serviceRequestGetOneMiddlewares,
    serviceRequestPutMiddlewares,
    serviceRequestDeleteMiddlewares,
    serviceRequestDeleteManyMiddlewares
} from "./middlewares.js";
