import ServiceRequest, { ServiceRequestQuery } from "../../schema/index.js"
...
const Unit = async ({query, update}:IndexParameter) =>{
    try {
        ...
        console.log(">>> invoking ServiceRequest.updateOne");
        console.log(">>> query", query);
        console.log(">>> update", update);
        const setUpdate = update || {};
        const response = await ServiceRequest.updateOne(query, {$set:setUpdate} );
